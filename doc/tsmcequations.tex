...
at $t_3$. See Fig.\ \ref{fig:diptripstate} for an illustration.
...
\begin{figure}[h!]
	...
	\caption{
        ...
        (panel A) and at $t_3$ (panel B). $D_2 = 0$ is the time of transition
        to diploid asexuality, and $D_3 < 0$ is the time of the transition to
        triploidy.
    }
