...
\begin{align}
    ...
    \frac{1}{\lambda_i^2}e^{-3\Omega(0,t_3)}e^{-2\Omega(t_3,t_2)}dt_2dt_3\\
    &= \frac{1}{\lambda_i^2}e^{-3\Omega(0,T_i)}\int_{T_i}^{T_{i+1}}
    e^{-3\Omega(T_i,t_3)}\int_{t_3}^{T_{i+1}}e^{-2\Omega(t_3,t_2)}dt_2dt_3\\
    &= \frac{1}{\lambda_i^2}e^{-3\Omega(0,T_i)}\int_{T_i}^{T_{i+1}}
    e^{-3\Omega(T_i,t_3)}\int_{t_3}^{T_{i+1}}e^{-\frac{2(t_3-t_2)}{\lambda_i}}dt_2dt_3\\
    &= \frac{1}{\lambda_i^2}e^{-3\Omega(0,T_i)}\int_{T_i}^{T_{i+1}}
    e^{-3\Omega(T_i,t_3)}\left(\frac{\lambda_i}{2}\left[e^{-\frac{2(T_{i+1}-t_3)}{\lambda_i}}-1\right]\right)dt_3\\
    &= \frac{1}{2\lambda_i}e^{-3\Omega(0,T_i)}\int_{T_i}^{T_{i+1}}
    e^{-\frac{3(t_3-T_i)}{\lambda_i}}\left(e^{-\frac{2(T_{i+1}-t_3)}{\lambda_i}}-1\right)dt_3\\
    &= \frac{1}{2\lambda_i}e^{-3\Omega(0,T_i)}
    \frac{\lambda_i}{3}\left(3e^{-\frac{2\Delta_i}{\lambda_i}}-2e^{-\frac{3\Delta_i}{\lambda_i}}-1\right)
    \end{split}
\end{align}
...
\begin{align}
    \begin{split}
        \E_{i,i}[t_3] &= \E\big[t_3|t_3 \in [T_i T_{i+1}),t_2 \in [T_i,T_{i+1}) \big]\\
                      ...
                      &= \frac{1}{\pi_{i,i}\lambda_i^2}\int_{T_i}^{T_{i+1}}
                        t_3\,e^{-3\Omega(0,t_3)}\int_{t_3}^{T_{i+1}}e^{-2\Omega(t_3,t_2)}dt_2\,dt_3\\
                    &= \frac{1}{\pi_{i,i}\lambda_i^2}e^{-3\Omega(0,T_i)}\int_{T_i}^{T_{i+1}}
                        t_3e^{-3\Omega(T_i,t_3)}\int_{t_3}^{T_{i+1}}e^{-2\Omega(t_3,t_2)}dt_2\,dt_3\\
                    &= \frac{1}{\pi_{i,i}\lambda_i^2}e^{-3\Omega(0,T_i)}
                        \int_{T_i}^{T_{i+1}}
                        t_3\,e^{-\frac{3(t_3-T_i)}{\lambda_i}}
                        \frac{\lambda_i}{2}\left(1-e^{-\frac{2(T_{i+1}-t_3)}{\lambda_i}}\right)dt_3\\
                    &= \frac{1}{2\pi_{i,i}\lambda_i}e^{-3\Omega(0,T_i)}
                        \int_{T_i}^{T_{i+1}}
                        t_3\,e^{-\frac{3(t_3-T_i)}{\lambda_i}}
                        \left(1-e^{-\frac{2(T_{i+1}-t_3)}{\lambda_i}}\right)dt_3\\
                    &= \frac{1}{2\pi_{i,i}\lambda_i}e^{-3\Omega(0,T_i)}
                        \left[\frac{\lambda_i}{9}e^{-\frac{3T_{i+1}}{\lambda_i}}
                        \left(e^{\frac{3T_{i+1}}{\lambda_i}}+e^{\frac{3T_i}{\lambda_i}}(6T_{i+1}+8\lambda_i)-9(\lambda_i+T_i)e^{-\frac{2\Delta_i}{\lambda_i}}\right)
                    \right]\\
                    &= \frac{1}{18\pi_{i,i}}e^{-3\Omega(0,T_i)}
                        \left[e^{-\frac{3T_{i+1}}{\lambda_i}}
                        \left(e^{\frac{3T_{i+1}}{\lambda_i}}+e^{\frac{3T_i}{\lambda_i}}(6T_{i+1}+8\lambda_i)-9(\lambda_i+T_i)e^{-\frac{2\Delta_i}{\lambda_i}}\right)
                    \right]\\
    \end{split}
\end{align}
...
\begin{align}
    \begin{split}
        \E_{i,i}[t_2] &= \E\big[t_2|t_3 \in [T_i T_{i+1}),t_2 \in [T_i,T_{i+1}) \big]\\
                      ...
                      &= \frac{1}{\pi_{i,i}}\int_{T_i}^{T_{i+1}}\int_{t_3}^{T_{i+1}}
                        \frac{t_2}{\lambda_i^2}e^{-3\Omega(0,t_3)}e^{-2\Omega(t_3,t_2)}dt_2\,dt_3\\
                      &= \frac{1}{\pi_{i,i}\lambda_i^2}\int_{T_i}^{T_{i+1}}
                      ...
                      &= \frac{1}{\pi_{i,i}\lambda_i^2}e^{-3\Omega(0,T_i)}
                        ...
                        dt_3\\
                      &= \frac{1}{\pi_{i,i}\lambda_i^2}e^{-3\Omega(0,T_i)}
                        \frac{\lambda_i}{4}e^{-\frac{3(t_2-T_i)}{\lambda_i}}\left(-T_i^2+T_{i+1}^2-\lambda_iT_i+T_{i+1}\lambda_i-
                        \frac{\lambda_i}{2}\left(1-e^{-\frac{2\Delta_i}{\lambda_i}}\right)\left(2T_{i+1}+\lambda_i\right)\right)\\
                      &= \frac{1}{\pi_{i,i}\lambda_i^2}e^{-3\Omega(0,T_i)}
                        \frac{\lambda_i}{4}e^{-\frac{3(t_2-T_i)}{\lambda_i}}\left(T_{i+1}^2-T_i^2+\lambda_i\left(\Delta_i-\frac{\lambda_i}{2}\left[1-e^{-\frac{2\Delta_i}{\lambda_i}}\right]\right)-
                        \frac{\lambda_i}{2}\left(1-e^{-\frac{2\Delta_i}{\lambda_i}}\right)\left(2T_{i+1}\right)\right)\\
    \end{split}
\end{align}
...
\begin{align*}
    ...
    \right)\times\\
    &\qquad\left(
    \lambda_k\left[1-e^{-\frac{T_{k+1}-s_2}{\lambda_k}}\right]
    \right)\\
\end{align*}
...
\begin{align*}
    ...
    e^{-\Omega(\E_{i,i}[s_2],T_l)}\lambda_l\left[1-e^{-\frac{\Delta_l}{\lambda_l}}\right]+\\
    &\qquad\qquad\qquad\qquad
...
\begin{align*}
    ...
    \left(\int_0^{s_3}e^{-3\Omega(u,s_3)}du\right)\\
    &=\frac{2}{2s_2+s_3}e^{-2\Omega(s_3,s_2)}\frac{1}{\lambda_l}
    \left(e^{-\Omega(s_2,T_l)}\lambda_l\left[1-e^{-\frac{\Delta_l}{\lambda_l}}\right]\right)
    \left(\int_0^{s_3}e^{-3\Omega(u,s_3)}du\right)\\
    &=\frac{2}{2s_2+s_3}e^{-2\Omega(s_3,s_2)}\frac{1}{\lambda_l}
    \left(e^{-\Omega(s_2,T_l)}\lambda_l\left[1-e^{-\frac{\Delta_l}{\lambda_l}}\right]\right)
    ...
    \left(e^{-\Omega(\E_{i,i}[s_2],T_l)}\lambda_l\left[1-e^{-\frac{\Delta_l}{\lambda_l}}\right]\right)\times\\
