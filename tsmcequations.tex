...
\subsection{Discrete emission probabilities}
...
\begin{equation}
    e_k(t_3,t_2, T_d) =
    \begin{cases}
        e^{-\frac{\theta\left(2t_2+t_3+3T_d\right)}{2}}&k=0\\
        e^{-\frac{\theta\left(t_2-t_3\right)}{2}}\left(1-e^{-\frac{\theta\left(2t_3+t_2+3T_d\right)}{2}}\right)&k=1\\
        \left(1-e^{-\frac{\theta\left(t_2-t_3\right)}{2}}\right)e^{-\frac{\theta\left(2t_3+t_2+3T_d\right)}{2}}&k=2\\
        \left(1-e^{-\frac{\theta\left(t_2-t_3\right)}{2}}\right)\left(1-e^{-\frac{\theta\left(2t_3+t_2+3T_d\right)}{2}}\right)&k=3.
    \end{cases}
...
\begin{equation}
    ...
    \begin{cases}
        e^{-\frac{\theta\left(2t_2+t_3+3T_d\right)}{2}}&k=0\\
        1-e^{-\frac{\theta\left(2t_2+t_3+3T_d\right)}{2}}&k=1.
    \end{cases}
    \label{eq:emissionprobsnopolar}
\end{equation}

The parameter $b$ can be tuned to match the observed polymorphism.
